...
namespace Data.Usuarios
{
    public partial class UsuarioData
    {
        private static string selectTabla() { 
            ...
            stringBuilder.Append("SELECT usuarios_usuario.id,usuarios_usuario.nombreusuario,usuarios_usuario.contrasena,usuarios_usuario.esactivo");
        ...
        public static Usuario insertarRegistro(Usuario usuario)
        {
            try {
                StringBuilder sql = new StringBuilder();
                sql.Append("INSERT INTO usuarios_usuario (id,nombreusuario,contrasena,esactivo) values(@id,@nombreusuario,@contrasena,@esactivo)");
                var conexion=Connection.getConnection();
        ...
        public static void actualizarRegistro(Usuario usuario) {
            try { 
                StringBuilder sql = new StringBuilder();
                sql.Append("UPDATE usuarios_usuario set nombreusuario=@nombreusuario,contrasena=@contrasena,esactivo=@esactivo");
