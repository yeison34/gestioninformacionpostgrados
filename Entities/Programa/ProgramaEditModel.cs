...
namespace Entities.Programa
{
    public class ProgramaEditModel
    {
        ...
        public ProgramaEditModel(int id, string codigo, string nombre, int? idfacultad,string correo, string descripcion, string lineastrabajo, DateTime fecha, string numerores, string archivores, string logo, bool espregrado, bool espostgrado, bool esactivo)
        {
            this.Id = id;
            this.Codigo = codigo;
            this.Nombre = nombre;
